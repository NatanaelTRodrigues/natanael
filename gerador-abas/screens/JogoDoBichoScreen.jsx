...
const imagemFundo = {
  uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCyWcRrH_argizXd9MuJiQ_9uPKq6D3ojOmA&s',
};
      ...
      <View style={styles.container}>
        ...
        {animalGerado && (
          <Card style={styles.card}>
            <Card.Content>
              <Text variant="titleLarge" style={styles.texto}>{animalGerado.nome}</Text>
